...
const handleCreateButtonFDO = (divCont, p_data_target, p_id,p_username,p_title) => {
    ...
    const btnDownload = handleBtnDownload(p_id);
...
const handleBtnOpen=(p_id)=>{
    ...
    btnOpen.addEventListener('click',(e)=>{ return handleOpen(e)});
    return btnOpen;
};
...
const handleBtnDownload=(p_id)=>{
    ...
    btnDownload.addEventListener('click',(e)=>{return handleDownload(e)});
    return btnDownload;
};

const handleBtnFavorite=(p_id)=>{
    let btnFavorite=handleCreateElement('button','btn-principal btn-favorite',  p_id);
    btnFavorite.addEventListener('click',(e)=>{return handleFavorite(btnFavorite)});
